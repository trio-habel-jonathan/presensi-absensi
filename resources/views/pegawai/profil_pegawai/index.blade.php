                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-center">
                            @if ($profilPegawai->foto_pegawai)
                                <img src="{{ asset('storage/' . $profilPegawai->foto_pegawai) }}" alt="Foto Pegawai"
                                    class="img-fluid rounded-circle mb-3"
                                    style="width: 150px; height: 150px; object-fit: cover;">
                            @else
                                <img src="{{ asset('img/default-profile.png') }}" alt="Foto Default"
                                    class="img-fluid rounded-circle mb-3"
                                    style="width: 150px; height: 150px; object-fit: cover;">
                            @endif
                        </div>
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <strong>Tempat, Tanggal Lahir:</strong> {{ $profilPegawai->tempat_lahir }},
                                    {{ Carbon\Carbon::parse($profilPegawai->tanggal_lahir)->format('d/m/Y') }}
                                </div>
                                <div class="col-md-6 mb-3">
                                    <strong>Jenis Kelamin:</strong>
                                    {{ $profilPegawai->jenis_kelamin == 'L' ? 'Laki-laki' : 'Perempuan' }}
                                </div>
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    {{ $profilPegawai->jenisPegawai->nama_jenis_pegawai ?? '-' }}
                                </div>
                                <div class="col-md-6 mb-3">
            ...
            <div class="card shadow-sm border-0 text-center py-5">
                <div class="card-body">
                    ...
                    <p class="text-muted mb-4">
                        Kamu belum membuat profil pegawai. Yuk lengkapi dulu data dirimu agar bisa lanjut menggunakan fitur
                        lainnya.
                    </p>
