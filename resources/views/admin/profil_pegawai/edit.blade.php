        ...
        <div class="col-12">
            ...
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h6>Edit Profil Pegawai</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('profil_pegawai.update', $profilPegawai->id_profil_pegawai) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="mb-3">
                                ...
                                @if ($profilPegawai->foto_pegawai)
                                    <small class="text-muted">Foto saat ini: <a href="{{ asset('storage/' . $profilPegawai->foto_pegawai) }}" target="_blank">Lihat</a></small>
                                @endif
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="tanggal_lahir" class="form-control" value="{{ old('tanggal_lahir', $profilPegawai->tanggal_lahir) }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="jenis_kelamin" class="form-select" required>
                                        <option value="L" {{ old('jenis_kelamin', $profilPegawai->jenis_kelamin) == 'L' ? 'selected' : '' }}>Laki-laki</option>
                                        <option value="P" {{ old('jenis_kelamin', $profilPegawai->jenis_kelamin) == 'P' ? 'selected' : '' }}>Perempuan</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="alamat" class="form-control" rows="4" required>{{ old('alamat', $profilPegawai->alamat) }}</textarea>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
